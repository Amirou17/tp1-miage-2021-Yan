...
_L'architecture hexagonale est un patron d'architecture utilisé dans le domaine de la conception des logiciels. Elle s'appuie sur 3 grands principes :
...
_Pour les adapteurs, nous allons écrire des tests unitaires_
